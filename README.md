# Projects ##########    5 or 4 SQL Projects ###################    2 or 3 Python Projects #################################  1 streamlit project utilising webscraping and maybe selenium ########################### 
...
- Data cleaning and preprocessing to handle missing values and ensure compatibility between datasets.
- Exploratory data analysis (EDA) to visualize distributions, correlations, and trends.
...
3. Training each machine learning model on the training set.
4. Evaluating the models' performance using accuracy metrics on the testing set.
